          ...
          <View style={{
            ...
            <View style={{ alignItems: 'center', marginBottom: spacing.lg }}>
              <Text style={{
                fontSize: 48,
                fontWeight: typography.weights.bold,
                color: getTrustScoreColor(profile.trust_score || 0),
              }}>
                {profile.trust_score || 0}
              </Text>
              <View style={{
                backgroundColor: getTrustScoreBadge(profile.trust_score || 0).color + '20',
                paddingHorizontal: spacing.md,
                paddingVertical: spacing.xs,
                borderRadius: 16,
                ...
                <Text style={{
                  color: getTrustScoreBadge(profile.trust_score || 0).color,
                  fontSize: typography.sizes.sm,
                  fontWeight: typography.weights.medium,
                }}>
              ...
              <Text style={{
                ...
                Your trust score is based on your activity and feedback
              </Text>
            </View>
              ...
              <View>
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    height: 8,
                    borderRadius: 4,
                    width: `${profile.completion_rate || 0}%`,
                  }} />
                </View>
              </View>
            ...
            <View style={{
              ...
              <View style={{ gap: spacing.xs }}>
                <Text style={{ fontSize: typography.sizes.sm, color: colors.semantic.info }}>
